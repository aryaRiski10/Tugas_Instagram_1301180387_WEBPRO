<?php 
    include "koneksi.php";
    session_start();
    $result_gambar = mysqli_query($koneksi, 'SELECT * FROM photo WHERE username = "' . $_SESSION["user"]["username"] . '"');
 ?>
        ...
        <header class="profile__header">
            ...
            <div class="profile__column">
                <div class="profile__title">
                    <h3 class="profile__username"> <?php $_SESSION["user"]["username"] ?></h3>
                    <a href="edit-profile.php">Edit profile</a>
                    <i class="fa fa-cog fa-lg"></i>
                </div>
                <ul class="profile__stats">
                    <li class="profile__stat">
                        <span class="stat__number"> <?= mysqli_num_rows($result_gambar) ?></span> posts
                    </li>
                    <li class="profile__stat">
                ...
                <p class="profile__bio">
                    ...
                    <?= $_SESSION["user"]["bio"] ?>
                    <a href="http:// <?= $_SESSION["user"]["website"] ?>" target = "_blank" > <?= $_SESSION["user"]["website"] ?> </a>
                </p> 
            </div>
        </header>
